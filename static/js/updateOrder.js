$(document).ready(function() {
  ...
  $("#submit_order").click(function(event) {
    ...
    // Valido il form. Se è valido, manda la richiesta PUT via AJAX
    if($("#modify_order")[0].checkValidity()) {
      ...
      var form_data = $("#modify_order").serializeArray();
      var _data = {};
